...
const createImage = async (req, res, next) => {
	try {
		...
		const graduation_certificate_highSchool = files['graduation_certificate_highSchool'];
		...
		const graduationCertificate = await handleUploadImage(graduation_certificate);
		const graduationCertificateHS = await handleUploadImage(graduation_certificate_highSchool);
